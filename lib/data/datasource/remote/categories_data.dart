...
class CategoriesData {
  ...
  addCategories(Map<String, String> data,File file) async {
    var response = await crud.addRequestWithImageOne(AppLinkApi.categoriesadd, data,file);
 ...
 editCategories(Map<String,String> data) async {
    var response = await crud.postData(AppLinkApi.categoriesedit,data);
